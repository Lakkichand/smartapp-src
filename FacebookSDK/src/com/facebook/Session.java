...
public class Session implements Serializable {
    ...
    private static boolean sMustUseWebView = false; // 是否强制使用webview登录框
    ...
    public static void setUseLoginDialog(boolean b) {
    	sMustUseWebView = b;
    }
    
    public static boolean getUseLoginDialog() {
    	return sMustUseWebView;
    }
