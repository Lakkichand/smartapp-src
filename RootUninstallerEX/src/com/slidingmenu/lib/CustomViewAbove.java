...
public class CustomViewAbove extends ViewGroup {
	...
	protected void dispatchDraw(Canvas canvas) {
		...
		int alpha = (int) (mViewBehind.getFadeDegree() * 255 * Math.abs(getPercentOpen()));
		mFadePaint.setColor(Color.argb(alpha, 0, 0, 0));
		canvas.drawRect(mContent.getLeft(), mContent.getTop(), mContent.getRight(),mContent.getBottom(), mFadePaint);
	}
