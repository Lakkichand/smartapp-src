 ...
 */
// CHECKSTYLE:OFF
public class ScrollerViewGroup extends ViewGroup implements
	...
	private int mGapWidth = DrawUtil.dip2px(TAApplication.getApplication(),
			10.0f);
	// 绘制间隙使用的画笔
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_MOVE: {
			...
			if (Math.abs(yoffset) < Math.abs(xoffset) && Math.abs(xoffset) > 15) {
	...
	/**
	 * <br>
	 * 功能简述:设置屏幕滚动到边缘页面时的滚动缓冲范围 <br>
	 * 功能详细描述: <br>
	 * 注意:padding 限制范围在[0, 0.5]
	 * 
	 * @param padding
	 *            限制范围在[0, 0.5]
	 */
	...
	public void setScreenScrollerListener(
			ScreenScrollerListener mScreenScrollerListener) {
