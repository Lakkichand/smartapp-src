...
import com.zhidian.wifibox.controller.CategoryContentController;
...
import com.zhidian.wifibox.controller.RankingController;
import com.zhidian.wifibox.controller.SearchController;
import com.zhidian.wifibox.controller.SpkExceptionController;
...
import com.zhidian.wifibox.message.CrashHandler;
...
public class TAApplication extends Application implements TAIResponseListener {
	...
	private void registerCommand() {
		...
		// 注册BannerView控制器
		TAApplication.getApplication().registerCommand(
				R.string.bannercontroller, BannerController.class);
		// 注册FeatureContainer控制器
		TAApplication.getApplication().registerCommand(
				R.string.featurecontroller, FeatureController.class);
		// 注册TopicController
		TAApplication.getApplication().registerCommand(
		...
		// 注册CategoryContentController
		TAApplication.getApplication().registerCommand(
				R.string.categorycontentcontroller,
				CategoryContentController.class);
		// 注册CommentController
		TAApplication.getApplication().registerCommand(
				R.string.commentcontroller, CommentController.class);
		// 注册RankingController
		TAApplication.getApplication().registerCommand(
				R.string.rankingcontroller, RankingController.class);
		// 注册MainController
		...
		// 注册XNewController
		TAApplication.getApplication().registerCommand(R.string.xnewcontroller,
				XNewController.class);
		// 注册XMustController
		TAApplication.getApplication().registerCommand(
				R.string.xmustcontroller, XMustController.class);
		// 注册XAllController
		TAApplication.getApplication().registerCommand(R.string.xallcontroller,
				XAllController.class);
		// 注册XBoxIdController
		TAApplication.getApplication().registerCommand(
				R.string.xboxidcontroller, XBoxIdController.class);
		// 注册SpkExceptionController
		TAApplication.getApplication().registerCommand(
				R.string.spkexceptioncontroller, SpkExceptionController.class);
		// 注册ProcessManagerController
		TAApplication.getApplication().registerCommand(
				R.string.processmanagercontroller,
				ProcessManagerController.class);
		// 注册CacheCleanerController
		TAApplication.getApplication().registerCommand(
				R.string.cachecleanercontroller, CacheCleanerController.class);
		// 注册TrashScanController
		TAApplication.getApplication().registerCommand(
				R.string.trashscancontroller, TrashScanController.class);
		...
		// 注册InstalledAppController
		TAApplication.getApplication().registerCommand(
				R.string.installedappcontroller, InstalledAppController.class);
	}
