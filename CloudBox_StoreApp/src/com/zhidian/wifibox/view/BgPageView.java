...
public class BgPageView implements OnClickListener {
	...
	public void showProgress() {
		...
		view = mInflater.inflate(R.layout.mydialog, null);
	...
	public void showLoadException(onCallBackOnClickListener listener) {
		...
		Button btnNewLoad = (Button) view
				.findViewById(R.id.loading_exception_again);
		btnNewLoad.setOnClickListener(this);
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.loading_exception_again:
		...
		case R.id.loading_exception_set:
