...
public class NavigationBar extends FrameLayout implements IMessageHandler {
	...
	private OnClickListener mListener = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			if (mCurrentView != null) {
				...
				View xianView = (View) mCurrentView.findViewById(R.id.xian);
				xianView.setVisibility(View.GONE);
			}
			{
				...
				View xianView = (View) v.findViewById(R.id.xian);
				xianView.setVisibility(View.VISIBLE);
			}
			mCurrentView = v;
		}
	};
	...
	protected void onFinishInflate() {
		...
		topic.setTag(R.id.app, 0xFF888888);
		topic.setTag(R.id.back, 0xFF33b5e5);
		// 应用
		...
		app.setTag(R.id.app, 0xFF888888);
		app.setTag(R.id.back, 0xFF33b5e5);
		// 推荐
		...
		feature.setTag(R.id.app, 0xFF888888);
		feature.setTag(R.id.back, 0xFF33b5e5);
		// 游戏
		...
		game.setTag(R.id.back, 0xFF33b5e5);
		// 管理
		...
		manage.setTag(R.id.app, 0xFF888888);
		manage.setTag(R.id.back, 0xFF33b5e5);
