...
import com.zhidian.wifibox.adapter.CategoryContentAdapter;
...
/**
 * 分类内容列表，数据由CategoryContentController提供
 * 
 * @author xiedezhi
 * 
 */
public class CategoryContentContainer extends FrameLayout implements IContainer {
				...
				if (bean.mPageIndex == 1) {
							...
							.showLoadException(new onCallBackOnClickListener() {
								...
								public void onClick() {
									...
									TARequest request = new TARequest(
											CategoryContentController.NEXT_PAGE,
											obj);
									TAApplication
											.getApplication()
											.doCommand(
					...
					mFoot.showRetry(new OnClickListener() {
						...
						public void onClick(View v) {
							...
							TARequest request = new TARequest(
									CategoryContentController.NEXT_PAGE, obj);
							TAApplication
									.getApplication()
									.doCommand(
											getContext()
			...
			if (view.getLastVisiblePosition() >= (view.getCount() - 1)) {
				...
				TAApplication.getApplication().doCommand(
						getContext().getString(
								R.string.categorycontentcontroller), request,
	...
	public CategoryContentContainer(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	...
	protected void onFinishInflate() {
		...
		mAdapter = new CategoryContentAdapter(getContext());
