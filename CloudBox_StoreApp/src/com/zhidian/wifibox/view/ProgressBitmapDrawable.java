...
public class ProgressBitmapDrawable extends BitmapDrawable {
	 ...
	 * 进度线宽
	 */
	private int mProgressWidth = DrawUtil.dip2px(
			TAApplication.getApplication(), 3.5f);
	...
	public void draw(Canvas canvas) {
		...
		// 画进度
		rectf = new RectF(rect.left + mGap * 2.5f, rect.top + mGap * 2.5f,
				rect.right - mGap * 2.5f, rect.bottom - mGap * 2.5f);
