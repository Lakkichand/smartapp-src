...
/**
 * 
 * @author android_wsj 1.扩展Gallery：
 */
public class AppImageGalleryView extends Gallery {

	private Camera mCamera = new Camera();// 相机类

	private int mMaxRotationAngle = 100;// 最大转动角度

	private int mMaxZoom = -120;// //最大缩放值

	private int mCoveflowCenter;// 半径值

	public AppImageGalleryView(Context context) {
	...
	public AppImageGalleryView(Context context, AttributeSet attrs) {
	...
	public AppImageGalleryView(Context context, AttributeSet attrs, int defStyle) {
	...
	protected boolean getChildStaticTransformation(View child, Transformation t) {
		...
		if (childCenter == mCoveflowCenter) {
			...
			transformImageBitmap((ImageView) child, t, 0);//旋转角度
