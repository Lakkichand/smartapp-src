...
public class CDataDownloader {
	...
	// "http://192.168.3.27:8080/CloudBox_ReceiveServer/";// 插件模块测试地址

	public static final String BASE_URL = "http://storeserver.yimipingtai.cn";
	public static final String ADT_BASE_URL = "http://receiveserver.yimipingtai.cn/";// 插件模块正式地址
	...
	public static String getHomeFeatureUrl() {
		return BASE_URL + "/apps/v2/home.shtml";
	}
