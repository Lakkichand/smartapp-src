...
//			}
	 ...
	 * 首次安装调用插件--市场spk安装接口
	 */
	private synchronized void firstInstallUserInfo(Context context) {
	 ...
	 * @param context 
	 */
	private synchronized void registerUserInfo(final Context context) {
		SharedPreferences prefs = PreferenceManager
				.getDefaultSharedPreferences(context);
		boolean b = prefs.getBoolean("hasRegisterUserInfo", false);
		if (!b) {
			TAApplication.getApplication().doCommand(
					TAApplication.getApplication().getString(R.string.maincontroller),
