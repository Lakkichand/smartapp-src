...
public class CrashHandleService extends Service {
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		if (path != null) {
			...
			dialog.setMessage("将问题发送给我们，让我们更多地优化产品和服务");
			dialog.setNegativeButton("不忍心",
			...
			dialog.setPositiveButton("扔块砖",
					new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface dialog, int which) {
							...
							params.put("mac", BoxIdManager.getInstance()
									.getBoxId());
							...
							Toast.makeText(CrashHandleService.this, "卖命发送ing…",
