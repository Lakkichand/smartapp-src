...
public class ImprintActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (ModeManager.getInstance().isRapidly()) {
			findViewById(R.id.cmode).setVisibility(View.GONE);
			findViewById(R.id.xmode).setVisibility(View.VISIBLE);
		} else {
			findViewById(R.id.cmode).setVisibility(View.VISIBLE);
			findViewById(R.id.xmode).setVisibility(View.GONE);
		}
	}
