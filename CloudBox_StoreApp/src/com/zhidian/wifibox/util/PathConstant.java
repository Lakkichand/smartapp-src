...
public class PathConstant {
	 ...
	 * 存放图标的文件目录
	 */
	public static final String ICON_ROOT_PATH = SDCARD + "/MIBAO/ICONS/";
	/**
	 * 普通模式下存放apk的根目录(SD卡)
	 */
	 ...
	 * 极速模式下存放apk的根目录(SD卡)
	 */
	public static final String X_APK_ROOTPATH = SDCARD + "/MIBAO/xdownload/";
	/**
	 * 极速模式下存放apk的根目录(cache)
	 */
	public static final String X_APK_ROOTPATH_CACHE = CACHE
			+ "/MIBAO/xdownload/";
	/**
	 * 存放极速模式downloadtask的文件地址
	 */
	public static final String X_TASK_PATH = CACHE + "/MIBAO/xdownloadtask";
	/**
	 * 临时文件后缀
	 */
