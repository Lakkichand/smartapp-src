...
public class SearchController extends TACommand {
	...
	public static final String DEFAULT_KEYWORD = "default_keyword";
	...
	protected void executeCommand() {
		...
		} else if (command.equals(DEFAULT_KEYWORD)) {
			CDataDownloader.getData(CDataDownloader.getDefautlSearchKeyUrl(),
					new AsyncHttpResponseHandler() {
						@Override
						public void onSuccess(String content) {
							...
							try {
								...
								Log.e("SearchController", "DEFAULT_KEYWORD:" + message);
							} catch (JSONException e) {
								e.printStackTrace();
							}
							
							SearchController.this.sendSuccessMessage(result);
