 ...
 * 
 */
public class RankController extends TACommand {

	/**
	 * 加载下一页命令
	 */
	public static final String NEXT_PAGE = "RankController_NEXT_PAGE";
	...
	protected void executeCommand() {
		...
		if (command.equals(NEXT_PAGE)) {
			...
			if (pageIndex == 1 && loadLocalDataFirst) {
				...
				bean.mDataType = PageDataBean.EXTRA_RANK;
				bean.mUrl = idUrl;
				...
				if (bean.mStatuscode == 0 && bean.mAppList != null
					...
					RankController.this.sendSuccessMessage(bean);
					// 连网获取数据
