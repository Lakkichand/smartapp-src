 ...
 * 极速模式全部应用页面控制器
 */
public class XAllController extends TACommand {

	/**
	 * 加载下一页命令
	 */
	public static final String NEXT_PAGE = "XALLCONTROLLER_NEXT_PAGE";
		...
		if (command.equals(NEXT_PAGE)) {
			...
			XDataDownload.getData(dataUrl, new AsyncHttpResponseHandler() {
				...
				public void onSuccess(String content) {
					...
					bean.mUrl = idUrl;
					bean.mPageIndex = 1;
					DataParser.parseXAllList(bean, content);
					XAllController.this.sendSuccessMessage(bean);
				}
