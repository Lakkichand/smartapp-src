...
public interface IDownloadInterface {
	 ...
	 */
	public static final String DOWNLOAD_REQUEST_ACTION = "DOWNLOAD_REQUEST_ACTION";
	/**
	 * 下载请求命令，添加下载任务
	 */
	...
	/**
	 * 下载模式发生改变广播Action（Activity向Service发送）
	 */
	public static final String DOWNLOAD_MODECHANGE_ACTION = "DOWNLOAD_MODECHANGE_ACTION";
	 ...
	 * 重新下载任务
	 */
	public void redownloadTask(String url, String iconUrl, String name,
			int size, String packName, long appId, String version);
