package com.zhidian.wifibox.pulldownlistview;
...
public class SpeedMustTreeView extends ExpandableListView implements
		OnScrollListener, OnGroupClickListener {
	public SpeedMustTreeView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		registerListener();
	}

	public SpeedMustTreeView(Context context, AttributeSet attrs) {
		super(context, attrs);
		registerListener();
	}

	public SpeedMustTreeView(Context context) {
		super(context);
		registerListener();
	}
