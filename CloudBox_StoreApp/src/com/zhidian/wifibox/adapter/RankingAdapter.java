...
public class RankingAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.btnRanking = (Button) convertView
					.findViewById(R.id.item_ranking_app_btn);
		...
		// holder.tvAppDescribe.setText(bean.explain);

		if (position == 0) {
			holder.btnRanking.setBackgroundResource(R.drawable.rank_01);
			holder.btnRanking.setTextColor(mContext.getResources().getColor(
					R.color.white));
		} else if (position == 1) {
			holder.btnRanking.setBackgroundResource(R.drawable.rank_02);
			holder.btnRanking.setTextColor(mContext.getResources().getColor(
					R.color.white));
		} else if (position == 2) {
			holder.btnRanking.setBackgroundResource(R.drawable.rank_03);
			holder.btnRanking.setTextColor(mContext.getResources().getColor(
					R.color.white));
		} else {
			holder.btnRanking.setBackgroundResource(R.drawable.rank_14);
			holder.btnRanking.setTextColor(R.color.grey_rank);
		}
		holder.btnRanking.setText(position + 1 + "");
