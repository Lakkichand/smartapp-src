...
public class HomeFeatureadapter extends BaseAdapter {
	...
	private OnClickListener mItemClickListener = new OnClickListener() {
		...
		@Override
		public void onClick(View v) {
			AppDataBean bean = (AppDataBean) v.getTag(R.id.aa);
	...
	private void initApp(AppDataBean bean, LinearLayout app,
		...
		Bitmap bm = AsyncImageManager.getInstance().loadImage(
				...
				bean.iconUrl, true, false, new AsyncImageLoadedCallBack() {
	 ...
	 */
	public void update(List<TransformationDataBean> list) {
		mList.clear();
