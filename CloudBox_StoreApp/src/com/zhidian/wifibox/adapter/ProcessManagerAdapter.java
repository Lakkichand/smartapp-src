...
public class ProcessManagerAdapter extends SectionedBaseAdapter {
	...
	public View getItemView(int section, int position, View convertView,
		...
		LinearLayout lock = (LinearLayout) convertView.findViewById(R.id.lock);
		ImageView lock_img = (ImageView) convertView
				.findViewById(R.id.lock_img);
		TextView lock_txt = (TextView) convertView.findViewById(R.id.lock_text);
		...
		if (bean.mIsProtection) {
			lock_img.setImageResource(R.drawable.icon_protect);
			lock_txt.setText("已保护");
			lock_txt.setTextColor(TAApplication.getApplication().getResources()
					.getColor(R.color.isprotected));
		} else {
			lock_img.setImageResource(R.drawable.icon_noprotect);
			lock_txt.setText("未保护");
			lock_txt.setTextColor(TAApplication.getApplication().getResources()
					.getColor(R.color.unprotected));
		}
		lock.setTag(bean);
