...
public class ErrorReportEmail {
    ...
    private String createLogFiles() {
        ...
        try {
            ShellUtils.sudo("/data/data/com.smartapp.easyvpn/busybox", "chmod", "0666", "/data/data/com.smartapp.easyvpn/log/*.log");
        } catch (Exception e) {
            LogUtils.e("failed to change log file permission", e);
            error += "\n" + "failed to change log file permission using busybox chmod" + "\n" + e;
            try {
                ShellUtils.sudo(ShellUtils.findCommand("chmod"), "0666", "/data/data/com.smartapp.easyvpn/log/*.log");
            } catch (Exception e2) {
    ...
    private String copyLog(String logFileName) {
        ...
        try {
            FileInputStream inputStream = new FileInputStream("/data/data/com.smartapp.easyvpn/log/" + logFileName);
            try {
