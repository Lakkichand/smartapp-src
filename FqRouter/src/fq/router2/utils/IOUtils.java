...
public class IOUtils {
    ...
    public static File ETC_DIR = new File("/data/data/com.smartapp.easyvpn/etc");
    public static File VAR_DIR = new File("/data/data/com.smartapp.easyvpn/var");
    public static File LOG_DIR = new File("/data/data/com.smartapp.easyvpn/log");
