...
public class ManagerProcess {
    ...
    public static void kill() throws Exception {
        ...
        if (new File("/data/data/com.smartapp.easyvpn/busybox").exists()) {
            ShellUtils.sudo("/data/data/com.smartapp.easyvpn/busybox", "killall", "python");
        } else {
        ...
        if (new File("/data/data/com.smartapp.easyvpn/busybox").exists()) {
            ShellUtils.sudo("/data/data/com.smartapp.easyvpn/busybox", "killall", "-KILL", "python");
        } else {
    ...
    public static boolean exists() {
        try {
            String output;
            if (new File("/data/data/com.smartapp.easyvpn/busybox").exists()) {
                output = ShellUtils.sudo("/data/data/com.smartapp.easyvpn/busybox", "killall", "-0", "python");
            } else {
    ...
    public static String getRunMode() {
        ...
        File runModeCacheFile = new File("/data/data/com.smartapp.easyvpn/etc/run-mode2");
