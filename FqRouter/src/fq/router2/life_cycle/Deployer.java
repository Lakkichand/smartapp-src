...
public class Deployer {
    ...
    private void clearDataDirectory() throws Exception {
        if (ShellUtils.DATA_DIR.exists()) {
            ...
            new File("/data/data/com.smartapp.easyvpn/busybox").delete();
        }
    }
    ...
    private void deleteDirectory(String path) throws Exception {
        if (new File(path).exists()) {
            try {
                ShellUtils.execute("/data/data/com.smartapp.easyvpn/busybox", "rm", "-rf", path);
            } catch (Exception e) {
    ...
    private void unzipPayloadZip() throws Exception {
        ...
        if (!new File("/data/data/com.smartapp.easyvpn/payload.zip").delete()) {
    ...
    private void linkLibs() throws Exception {
        ...
        ShellUtils.sudo("/data/data/com.smartapp.easyvpn/busybox", "mount", "-o", "remount,rw", "/system");
        try {
            ...
            ShellUtils.sudo("/data/data/com.smartapp.easyvpn/busybox", "mount", "-o", "remount,ro", "/system");
        }
    }
...
//        }
    ...
    private void makeExecutable(File file) throws Exception {
        try {
            ...
            ShellUtils.execute("/data/data/com.smartapp.easyvpn/busybox", "chmod", "0700", file.getAbsolutePath());
            LogUtils.i("successfully made " + file.getName() + " executable");
        }
    }
