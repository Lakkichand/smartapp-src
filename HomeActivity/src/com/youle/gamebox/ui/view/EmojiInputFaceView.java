...
public class EmojiInputFaceView extends LinearLayout{
    @InjectView(R.id.btn_let_me_send)
	Button letMeSendBtn;
    ...
    public EmojiInputFaceView(Context context) {
        super(context);
        init(context);
    }

    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public EmojiInputFaceView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context);
    }


    public EmojiInputFaceView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    private void init(Context context){
        mContext = context;
        View view = LayoutInflater.from(mContext).inflate(R.layout.emoji_bottom_input_layout,this);
      ...
      //  sendBtn.setOnTouchListener(mainListener);
        letMeSendBtn.setOnClickListener(letMeSendListener);
     ...
     * @return
     */
    public void setShowBtnText(String showText){
        if(letMeSendBtn!=null){
            if(showText!=null && !"".equals(showText))letMeSendBtn.setText(showText);
        }
    }
    /**
	...
	public void closeEdit(){
        ...
        letMeSendBtn.setVisibility(View.VISIBLE);
	...
	public void showEditLayout(String hint) {
		...
		letMeSendBtn.setVisibility(View.GONE);
		commentEdit.clearFocus();
