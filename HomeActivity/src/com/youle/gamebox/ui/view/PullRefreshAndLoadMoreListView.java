...
public class PullRefreshAndLoadMoreListView extends PullToRefreshListView {
	...
	private void init(Context context) {
		mFooterView = View.inflate(context, R.layout.load_next_vertical, null);
        mFooterView.findViewById(R.id.footLayout).setVisibility(VISIBLE);
	 ...
	 * @param listener
	 *            OnLoadMoreListener
	 * @see com.youle.gamebox.ui.view.PullRefreshAndLoadMoreListView.OnLoadMoreListener
	 */
