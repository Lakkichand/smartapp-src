...
public class PullToRefreshListView extends ListView {
	...
	private void initView(Context context) {
		...
		mHeader = inflater.inflate(R.layout.refresh_head, null);
		iv_arrow = (ImageView) mHeader.findViewById(R.id.loadImage);
		pb_refresh = (ProgressBar) mHeader.findViewById(R.id.pull_to_refresh_progress);
		tv_title = (TextView) mHeader.findViewById(R.id.title);
