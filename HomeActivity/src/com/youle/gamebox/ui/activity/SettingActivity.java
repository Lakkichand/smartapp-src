...
//        ButterKnife.inject(this);
        ...
        mAutoInstall = (CheckBox) findViewById(R.id.autoInstall);
        mDeleteInstalled = (CheckBox) findViewById(R.id.deleteInstalled);
        mShowImage = (CheckBox) findViewById(R.id.showImage);
        mCleanCache = (CheckBox) findViewById(R.id.cleanCache);
