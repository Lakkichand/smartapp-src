...
public class RankFragment extends BaseFragment implements ViewPager.OnPageChangeListener {
    ...
    protected void loadData() {
        ...
        adapter = new RankAdapter(getFragmentManager());
        mViewPage.setAdapter(adapter);
            ...
            switch (i){
                ...
                case 2:
                    if(monthFragment==null){
                        monthFragment = new RankItemFragment(RankApi.RankType.MONTH) ;
                    }
                    return  monthFragment ;
                case 3:
                    if(weekFragment==null){
                        weekFragment = new RankItemFragment(RankApi.RankType.WEEK);
                    }
                    return weekFragment ;
            }
            return  null ;
