...
public class DymaicListBean {
    ...
    private int voiceSeconds  ;//int 语音长度
    private int tAmount  ;//int 文字评论数量
    private int vAmount  ;//int 语音评论数量
    private int lAmount  ;//int 赞的数量
    ...
    public void setVoiceSeconds(int voiceSeconds) {
