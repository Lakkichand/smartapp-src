...
public class FileSortHelper {
	...
	private Comparator cmpType = new FileComparator() {
		@Override
		public int doCompare(FileInfo object1, FileInfo object2) {
			int result = MediaFileUtil.getExtFromFilename(object1.fileName).compareToIgnoreCase(
					MediaFileUtil.getExtFromFilename(object2.fileName));
			if (result != 0) {
				return result;
			}

			return MediaFileUtil.getNameFromFilename(object1.fileName).compareToIgnoreCase(
					MediaFileUtil.getNameFromFilename(object2.fileName));
		}
	};
}
