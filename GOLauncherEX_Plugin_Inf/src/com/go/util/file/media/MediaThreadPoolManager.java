...
public class MediaThreadPoolManager {
	...
	private static HashMap<String, MediaThreadPoolManager> sThreadPoolManagerhHashMap = null;
	...
	private MediaThreadPoolManager(int corePoolSize, int maximumPoolSize, long keepAliveTime,
	...
	public synchronized static MediaThreadPoolManager getInstance(String threadPoolManagerName) {
		MediaThreadPoolManager threadPoolManager = null;
		if (threadPoolManagerName != null && !"".equals(threadPoolManagerName.trim())) {
			if (null == sThreadPoolManagerhHashMap) {
				sThreadPoolManagerhHashMap = new HashMap<String, MediaThreadPoolManager>();
			}
			threadPoolManager = sThreadPoolManagerhHashMap.get(threadPoolManagerName);
			if (null == threadPoolManager) {
				threadPoolManager = new MediaThreadPoolManager();
	...
	public synchronized static void buildInstance(String threadPoolManagerName, int corePoolSize,
		...
		if (threadPoolManagerName == null || "".equals(threadPoolManagerName.trim())
			...
			MediaThreadPoolManager threadPoolManager = new MediaThreadPoolManager(corePoolSize,
