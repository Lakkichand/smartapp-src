...
public class HolographicOutlineHelper {
	...
	public static void resetDensity(float scale) {
	...
	/**
	 * Apply an outer blur to the given bitmap. You should use OUTER_BLUR_RADIUS
	 * to ensure that the bitmap is big enough to draw the blur without
	 * clipping.
	 */
	...
	void applyExpensiveOutlineWithBlur(Bitmap srcDst, Canvas srcDstCanvas, int color,
		...
		srcDstCanvas.drawBitmap(glowShape, -thickInnerBlurOffset[0], -thickInnerBlurOffset[1],
				mErasePaint);
	...
	public void applyExtraThickExpensiveOutlineWithBlur(Bitmap srcDst, Canvas srcDstCanvas,
