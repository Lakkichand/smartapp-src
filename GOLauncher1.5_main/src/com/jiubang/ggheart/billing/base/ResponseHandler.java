...
//			sPurchaseObserver.onBillingSupported(supported, type);
			sPurchaseObserver.postBillingSupported(supported, type);
		}
	}
	...
	public static void buyPageIntentResponse(PendingIntent pendingIntent, Intent intent) {
		if (sPurchaseObserver == null) {
			if (Consts.DEBUG) {
				Log.d(Consts.TAG, "UI is not running");
			}
			return;
		}
	...
	public static void purchaseResponse(final Context context, final PurchaseState purchaseState,
		...
		if (sPurchaseObserver != null) {
			sPurchaseObserver.postPurchaseStateChange(purchaseState, productId, quantity,
