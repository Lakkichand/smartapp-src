 ...
 * 
 */
public class AppfuncsearchScroller extends ViewGroup implements ScreenScrollerListener {
	...
	private SearchNavigationbarIcon mNavigationbarIcon = null;
	/**
	 * 跟页面间的间隙绘制有关的变量
	 */
	// 是否绘制间隙，默认不绘制
	...
	public AppfuncsearchScroller(Context context, AttributeSet attrs,
			ScreenScrollerListener screenScrollerListener) {
		super(context, attrs);
		init(context, screenScrollerListener);
	}

	public AppfuncsearchScroller(Context context, ScreenScrollerListener screenScrollerListener) {
		super(context);
		init(context, screenScrollerListener);
	}
	...
	public void setSearchNavigationbarIcon(SearchNavigationbarIcon icon) {
		mNavigationbarIcon = icon;
	}
}
