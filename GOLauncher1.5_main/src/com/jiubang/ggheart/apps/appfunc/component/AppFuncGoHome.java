...
public class AppFuncGoHome extends XButton implements IComponentEventListener {
	...
	public AppFuncGoHome(Context context, int tickCount, int x, int y, int width, int height) {
	...
	// @Override
	// public boolean onTouch(MotionEvent arg0) {
