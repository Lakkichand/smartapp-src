 ...
 * 
 */
public class ScaleReduceAnimation extends Animation {
	private int mFromX;
	private int mToX;
	 ...
	 *            otherwise.
	 */
	public ScaleReduceAnimation(int fromLenth, int toLenth, TextView progressView,
			TextView showText, long usedMemory) {
		mFromX = fromLenth;
		mToX = toLenth;
	...
	protected void applyTransformation(float interpolatedTime, Transformation t) {
		...
		mShowText.setText(mUsedMemory - (int) (mUsedMemory * interpolatedTime) + "M");
		mProgressView.setWidth(mFromX + sx);
		// }else{
		// mProgressView.setWidth(DrawUtils.dip2px(20));
		// }
