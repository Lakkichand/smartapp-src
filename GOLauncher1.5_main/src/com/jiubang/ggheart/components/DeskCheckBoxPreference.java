...
public class DeskCheckBoxPreference extends CheckBoxPreference
		implements
			ISelfObject,
			TextFontInterface {
	...
	public DeskCheckBoxPreference(Context context) {
		super(context);
		selfConstruct();
	}

	public DeskCheckBoxPreference(Context context, AttributeSet attrs) {
		super(context, attrs);
		selfConstruct();
	...
	public DeskCheckBoxPreference(Context context, AttributeSet attrs, int defStyle) {
