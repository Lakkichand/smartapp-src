/*
 * 文 件 名:  PriceAlertController.java
 * 版    权:  3G
 * 描    述:  <描述>
 * 修 改 人:  liuxinyang
 * 修改时间:  2012-12-14
 ...
 * @date  [2012-12-14]
 */
public class PriceAlertController extends BaseController {
	...
	public PriceAlertController(Context context, IModeChangeListener listener) {
	...
	protected Object handleRequest(int action, Object parames) {
		if (action == sACTION_NEXT_PAGE) {
			...
			mNextPageRunnable = new NextPageRunnable(typeid, currentPage, startIndex);
