...
public class AppHttpAdapter {
	...
	private void initAppHeartUrl() {
		if (mHttpAdapter != null) {
			putCommonHeartUrl(DownloadUtil.getHost(AppsNetConstant.APP_CENTER_URL_CHINA),
					AppsNetConstant.HEART_APPCENTER_CHINA);
			putCommonHeartUrl(DownloadUtil.getHost(AppsNetConstant.APP_CENTER_URL_OTHERS),
	...
	public void addTask(boolean isAlive, THttpRequest request) {
		...
		if (mIsAliveEnable && channelAliveEnable) {
