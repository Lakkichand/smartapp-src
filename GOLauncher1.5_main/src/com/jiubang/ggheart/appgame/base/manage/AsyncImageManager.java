...
//	};
	...
	private AsyncImageManager(IImageCache imageCache) {
		...
		//检查WIFI是否可用
		mIsWifiEnable = GoStorePhoneStateUtil.isWifiEnable(GOLauncherApp.getContext());
	}
	...
	public Bitmap loadImage(final String imgPath, final String imgName, final String imgUrl,
		...
		// 这里根据设置对图片加载进行了控制
		int loadtype = AppGameSettingData.getInstance(GOLauncherApp.getContext())
