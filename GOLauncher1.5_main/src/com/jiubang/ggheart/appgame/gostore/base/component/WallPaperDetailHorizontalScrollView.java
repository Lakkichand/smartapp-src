...
public class WallPaperDetailHorizontalScrollView extends HorizontalScrollView {
	...
	public WallPaperDetailHorizontalScrollView(Context context) {
		super(context);
		mContext = context;
		initView();
	}

	public WallPaperDetailHorizontalScrollView(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
		initView();
	}

	public WallPaperDetailHorizontalScrollView(Context context, AttributeSet attrs, int defStyle) {
