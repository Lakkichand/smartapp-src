...
public class GridViewController extends BaseController {
	...
	public GridViewController(Context context, IModeChangeListener listener) {
	...
	public void onItemClick(Context context, BoutiqueApp app, ArrayList<String> appids,
			ArrayList<String> pkgs, ArrayList<String> icons, int showList) {
		if (app == null) {
			return;
		}
		int startType = AppsDetail.START_TYPE_APPRECOMMENDED;
		AppsDetail.jumpToThemeDetail(context, app, startType, app.index, true, appids, pkgs, icons,
				showList);
	}
