...
public class DownloadManager extends Thread {
	...
	private static final int MAX_handler_COUNT = 1000;
	private static final int MAX_DOWNLOAD_THREAD_COUNT = 1;//可同时下载的个数
	...
	private AsyncHttpResponseHandler newAsyncHttpResponseHandler(String url)
		...
		FileHttpResponseHandler handler = new FileHttpResponseHandler(url,
			...
			public void onProgress(long totalSize, long currentSize,
				...
				super.onProgress(totalSize, currentSize, speed, time);
				if (mDownLoadCallback != null) {
					mDownLoadCallback.sendLoadMessage(this.getUrl(), totalSize,
							currentSize, speed, time);
				}
			}
