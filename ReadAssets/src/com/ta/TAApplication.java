...
public class TAApplication extends Application implements TAIResponseListener {
	...
	private void registerCommand() {
		// 注册GainAPKController控制器
		TAApplication.getApplication().registerCommand(
				R.string.gainapkcontroller, GainAPKController.class);
		// 注册CheckFailApkController控制器
		TAApplication.getApplication().registerCommand(
				R.string.checkfailapkcontroller, CheckFailApkController.class);
