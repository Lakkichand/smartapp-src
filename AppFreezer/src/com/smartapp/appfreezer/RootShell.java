...
public class RootShell {
	 ...
	 */
	private RootShell() throws IOException, RootDeniedException,
	 ...
	 * 获取单实例
	 */
	public static synchronized RootShell getInstance() throws IOException,
			RootDeniedException, InterruptedException {
		if (sInstance == null) {
