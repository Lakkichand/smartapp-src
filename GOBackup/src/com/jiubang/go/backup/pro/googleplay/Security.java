...
public class Security {
	...
	public static ArrayList<VerifiedPurchase> verifyPurchase(String signedData, String signature) {
		...
		if (!TextUtils.isEmpty(signature)) {
			 ...
			 * publisher site). Instead of just storing the entire literal
			 * string here embedded in the program, construct the key at runtime
			 * from pieces or use bit manipulation (for example, XOR with some
			 * other string) to hide the actual key. The key itself is not
			 * secret information, but we don't want to make it easy for an
			 * adversary to replace the public key with one of their own and
			 * then fake messages from the server. Generally, encryption keys /
			 * passwords should only be kept in memory long enough to perform
			 * the operation they need to perform.
			 */
			// 公钥字符串
			// String base64EncodedPublicKey = "your public key here";
			String base64EncodedPublicKey = "";
