...
import com.jiubang.go.backup.pro.lib.contacts.util.BinaryDecoder;
import com.jiubang.go.backup.pro.lib.contacts.util.BinaryEncoder;
import com.jiubang.go.backup.pro.lib.contacts.util.DecoderException;
import com.jiubang.go.backup.pro.lib.contacts.util.EncoderException;
import com.jiubang.go.backup.pro.lib.contacts.util.StringDecoder;
import com.jiubang.go.backup.pro.lib.contacts.util.StringEncoder;
 ...
 * @since 1.3
 * @version $Id: QuotedPrintableCodec.java,v 1.7 2004/04/09 22:21:07 ggregory
 *          Exp $
 */
public class QuotedPrintableCodec
	...
	public Object encode(Object pObject) throws EncoderException {
		if (pObject == null) {
			...
			throw new EncoderException("Objects of type " + pObject.getClass().getName()
	 ...
	 *             objects of this type if decoding is unsuccessful
	 */
	public Object decode(Object pObject) throws DecoderException {
		if (pObject == null) {
			...
			throw new DecoderException("Objects of type " + pObject.getClass().getName()
