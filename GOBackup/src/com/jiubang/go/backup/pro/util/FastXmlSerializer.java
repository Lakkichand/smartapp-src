...
public class FastXmlSerializer implements XmlSerializer {
	private static final String ESCAPE_TABLE[] = new String[] { null, null, null, null, null, null,
			null, null, // 0-7
	...
	private void escapeAndAppendString(final String string) throws IOException {
		final int mN = string.length();
		final char mNE = (char) ESCAPE_TABLE.length;
	...
	public void setOutput(OutputStream os, String encoding) throws IOException,
		...
		if (true) {
			try {
				...
				throw (UnsupportedEncodingException) (new UnsupportedEncodingException(encoding)
						.initCause(e));
			...
			setOutput(encoding == null ? new OutputStreamWriter(os) : new OutputStreamWriter(os,
					encoding));
		}
	}
