...
public class SendReq extends MultimediaMessagePdu {
	...
	public SendReq() {
		...
		try {
			...
			// Impossible to reach here since all headers we set above are
			// valid.
	 ...
	 *            the from value
	 * @param mmsVersion
	 *            current viersion of mms
	 * @param transactionId
	 *            the transaction-id value
	 * @throws InvalidHeaderValueException
	 *             if parameters are invalid. NullPointerException if
	 *             contentType, form or transactionId is null.
	 */
	...
	/***
	 * Get X-Mms-Expiry value. Expiry-value = Value-length (Absolute-token
	 * Date-value | Relative-token Delta-seconds-value)
	 * 
	 * @return the value
	 */
	...
	/***
	 * Get X-Mms-MessageSize value. Expiry-value = size of message
	 * 
	 * @return the value
	 */
	...
	/**
	 * Optional, not supported header fields: public byte getAdaptationAllowed()
	 * {return 0}; public void setAdaptationAllowed(btye value) {}; public
	 * byte[] getApplicId() {return null;} public void setApplicId(byte[] value)
	 * {} public byte[] getAuxApplicId() {return null;} public void
	 * getAuxApplicId(byte[] value) {} public byte getContentClass() {return
	 * 0x00;} public void setApplicId(byte value) {} public long
	 * getDeliveryTime() {return 0}; public void setDeliveryTime(long value) {};
	 * public byte getDrmContent() {return 0x00;} public void setDrmContent(byte
	 * value) {} public MmFlagsValue getMmFlags() {return null;} public void
	 * setMmFlags(MmFlagsValue value) {} public MmStateValue getMmState()
	 * {return null;} public void getMmState(MmStateValue value) {} public
	 * byte[] getReplyApplicId() {return 0x00;} public void
	 * setReplyApplicId(byte[] value) {} public byte getReplyCharging() {return
	 * 0x00;} public void setReplyCharging(byte value) {} public byte
	 * getReplyChargingDeadline() {return 0x00;} public void
	 * setReplyChargingDeadline(byte value) {} public byte[]
	 * getReplyChargingId() {return 0x00;} public void setReplyChargingId(byte[]
	 * value) {} public long getReplyChargingSize() {return 0;} public void
	 * setReplyChargingSize(long value) {} public byte[] getReplyApplicId()
	 * {return 0x00;} public void setReplyApplicId(byte[] value) {} public byte
	 * getStore() {return 0x00;} public void setStore(byte value) {}
	 */
}
