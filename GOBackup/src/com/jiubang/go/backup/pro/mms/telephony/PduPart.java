...
public class PduPart {
	...
	/***
	 * @return A copy of the part data or null if the data wasn't set or the
	 *         data is stored as Uri.
	 * @see #getDataUri
	 */
	public byte[] getData() {
		if (mPartData == null) {
	...
	/***
	 * @return The Uri of the part data or null if the data wasn't set or the
	...
	public void setContentId(byte[] contentId) {
		...
		if ((contentId.length > 1) && ((char) contentId[0] == '<')
	 ...
	 *         (Attachment). return PduPart.disposition[2] instead of <Octet
	 *         130> (Inline).
	 */
	...
	/***
	 * Set Content-Disposition value. Use PduPart.disposition[0] instead of
	 * <Octet 128> (Form-data). Use PduPart.disposition[1] instead of <Octet
	 * 129> (Attachment). Use PduPart.disposition[2] instead of <Octet 130>
	 * (Inline).
	 * 
