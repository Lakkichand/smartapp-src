...
public final class Telephony {
	...
	public static final class Intents {
		 ...
		 * placeholder string (eg, "No service"). It is recommended to display
		 * <em>plmn</em> before / above <em>spn</em> if both are displayed.
		 * <p>
	...
	public static String getFrom(Context context, Uri uri) {
		...
		Cursor cursor = SqliteWrapper.query(context, context.getContentResolver(), builder.build(),
				new String[] { Addr.ADDRESS, Addr.CHARSET }, Addr.TYPE + "=" + PduHeaders.FROM,
				null, null);
