...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		adFrame = (FrameLayout) findViewById(R.id.frame);
		...
		Toast.makeText(getApplication(), R.string.toggle_fullscreen,
		...
		adView.setAdUnitId("ca-app-pub-6335053266754945/7850454114");
